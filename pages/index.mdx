...
Soy Álvaro, un DevOps de Madrid, España con +6 años de experiencia en este campo. Me apasiona la tecnología, la automatización y la optimización de procesos. En este sitio encontrarás recursos, herramientas y artículos relacionados con DevOps, infraestructura como código, Kubernetes, Terraform y mucho más.
