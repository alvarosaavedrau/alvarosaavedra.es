...
Soy Álvaro, **ingeniero DevOps** en Madrid, con más de 6 años de experiencia diseñando y mejorando plataformas cloud.

Me apasiona convertir procesos complejos en soluciones simples, automatizadas y fiables. Aquí comparto contenido práctico sobre **DevOps**, **infraestructura como código**, **Kubernetes**, **Terraform** y otras herramientas que utilizo en el día a día.
