...
Vamos a empzar a jugar, vamos a ver como crear un CDN con [CloudFront](https://aws.amazon.com/es/cloudfront/) y [S3](https://aws.amazon.com/es/s3/) para almacenar los objetos (archivos) que queremos distribuir. Usaremos terraform para desplegar la infraestructura.
