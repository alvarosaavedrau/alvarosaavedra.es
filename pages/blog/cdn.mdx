...
El S3 es el servicio que nos permite almacenar los objetos que queremos entregar. Si deseas acceder a los ficheros mediante un dominio personalizado, el nombre del S3 debe ser este nombre de dominio. Si no quieres usar un dominio personalizado y accederás a tus objetos mediante la URL generada por CloudFront, el nombre del S3 puede ser el que tú quieras. En este caso quiero acceder mediante `cdn.alvarosaavedra.es` asi que el nombre de mi S3 será este.
